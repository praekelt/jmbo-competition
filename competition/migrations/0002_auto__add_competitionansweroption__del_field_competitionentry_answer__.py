...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompetitionEntry.answer'
        db.delete_column('competition_competitionentry', 'answer')

        # Adding field 'CompetitionEntry.answer_text'
        db.add_column('competition_competitionentry', 'answer_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionEntry.answer_option'
        db.add_column('competition_competitionentry', 'answer_option',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.CompetitionAnswerOption'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CompetitionAnswerOption'
        db.delete_table('competition_competitionansweroption')

        # Adding field 'CompetitionEntry.answer'
        db.add_column('competition_competitionentry', 'answer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'CompetitionEntry.answer_text'
        db.delete_column('competition_competitionentry', 'answer_text')

        # Deleting field 'CompetitionEntry.answer_option'
    ...
    models = {
        ...
        'competition.competitionentry': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'competition_entries_users'", 'to': "orm['auth.User']"}),
