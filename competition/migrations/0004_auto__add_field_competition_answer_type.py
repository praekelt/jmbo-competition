...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('competition_competition', 'answer_type',
                      self.gf('django.db.models.fields.CharField')(default='free_text_input', max_length=32),
                      keep_default=False)
    ...
    models = {
        ...
        'competition.competition': {
            ...
            'answer_type': ('django.db.models.fields.CharField', [], {'default': "'free_text_input'", 'max_length': '32'}),
