...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Competition.answer_type'
        db.alter_column('competition_competition', 'answer_type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Competition.end_date'
        db.alter_column('competition_competition', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 22, 0, 0)))

        # Changing field 'Competition.start_date'
        db.alter_column('competition_competition', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 22, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Competition.answer_type'
        db.alter_column('competition_competition', 'answer_type', self.gf('django.db.models.fields.CharField')(max_length=32))
